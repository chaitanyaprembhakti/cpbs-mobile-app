...
export const LibraryScreen: React.FC<LibraryScreenProps> = ({
          ...
          return (
              <div className="min-h-full pb-4">
                  <div dir={scrollBarSide === 'left' ? 'ltr' : undefined}>
                    <div className="sticky top-0 z-10 bg-transparent backdrop-blur-md p-4 border-b border-[#bc8d31]/30 flex items-center justify-between shadow-sm">
                        ...
                        <div className="p-2 space-y-2">
                            {activePlaylist.items.map((bhajanId, idx) => {
                                ...
                                return (
                                    <div 
                                      key={bhajanId} 
                                      className="flex items-center justify-between pr-4 group animate-fade-in-up opacity-0 fill-mode-forwards rounded-2xl border border-transparent hover:bg-white/10 dark:hover:bg-slate-800 hover:shadow-sm hover:border-[#bc8d31]/20 transition-all"
              ...
              <div dir={scrollBarSide === 'left' ? 'ltr' : undefined}>
                ...
                <div className="space-y-3 mt-4">
                    {playlists.map((playlist, idx) => (
                        <div 
                            key={playlist.id} 
                            className="bg-transparent dark:bg-slate-800 rounded-2xl shadow-sm border border-[#bc8d31]/20 overflow-hidden flex items-center animate-fade-in-up opacity-0 fill-mode-forwards hover:border-[#bc8d31]/50 hover:shadow-md transition-all group"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div className="relative group">
                            <button 
                                ...
                                className="w-full flex flex-col items-center justify-center p-4 bg-transparent dark:bg-slate-800 border border-[#bc8d31]/20 rounded-2xl hover:bg-[#bc8d31]/5 transition-colors shadow-sm gap-2"
                            >
              ...
              <div dir={scrollBarSide === 'left' ? 'ltr' : undefined}>
                {filteredSingers.map((singer, idx) => {
                    ...
                    return (
                        <div 
                            key={idx} 
                            className={`rounded-2xl transition-all duration-300 border ${isExpanded ? 'bg-transparent dark:bg-slate-800 border-[#bc8d31]/40 shadow-md' : 'bg-transparent border-transparent hover:bg-[#bc8d31]/5 dark:hover:bg-slate-800'} animate-fade-in-up opacity-0 fill-mode-forwards mb-2`}
                        ...
                        >
                            ...
                            {isExpanded && (
                                <div className="px-4 pb-4 pt-0 animate-fade-in">
                                    <ul className="bg-transparent dark:bg-slate-900/50 rounded-xl p-2 space-y-1 border border-[#bc8d31]/20">
                                            ...
                                            return (
                                                ...
                                                >
                                                    <button 
                                                        ...
                                                        className="w-full text-left py-3 px-3 rounded-lg flex items-center gap-3 hover:bg-white/10 dark:hover:bg-slate-800 border border-transparent hover:border-[#bc8d31]/30 hover:shadow-sm transition-all group/item"
                                                    >
  ...
  return (
    <div className="flex flex-col h-full bg-transparent">
      ...
      {/* Top Tabs */}
      <div className="flex bg-transparent backdrop-blur-md border-b border-[#bc8d31]/30 sticky top-0 z-20 items-center pr-2">
