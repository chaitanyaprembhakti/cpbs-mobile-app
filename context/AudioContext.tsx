...
const defaultIcon = '/icon.png'; // Updated to point to icon.png
...
export const AudioProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const playTrack = async (track: BhajanAudio, title: string, parentBhajan?: Bhajan, imageUrl: string = defaultIcon, contextQueue?: BhajanAudio[], contextTitle?: string) => {
    ...
    if (Capacitor.isNativePlatform()) {
      try {
        await MediaSession.setMetadata({
          ...
          artwork: [
            { src: artworkSrc, sizes: '1024x1024', type: 'image/png' } // Updated sizes to 1024x1024
          ]
        });
